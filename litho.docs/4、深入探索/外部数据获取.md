...
**外部数据获取**是 mns（Market Neutral Strategist）系统中至关重要的基础设施模块，负责从外部市场情绪源——CNN Fear & Greed Index API——稳定、安全、结构化地获取实时市场情绪数据。该模块作为系统“感知市场情绪”的唯一入口，为策略引擎、报告生成等核心业务模块提供关键输入变量，是实现“逆向投资”逻辑的基石。
