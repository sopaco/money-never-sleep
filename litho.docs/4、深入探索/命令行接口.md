...
#[command(name = "mns")]
#[command(version)]
#[command(about = "逆情绪投资助手 - Money Never Sleeps（Market Neutral Strategist）")]
pub struct Cli {
    #[command(subcommand)]
...
mns market                  → 获取综合市场概览
mns market-indices          → 获取全球9大市场指数
mns analyze AAPL            → 分析苹果股票行情
mns analyze QQQ             → 分析纳指100 ETF
```
...
$ mns --help
mns 
逆情绪投资助手 - Money Never Sleeps（Market Neutral Strategist）
...
Commands:
  ...
  market         获取综合市场概览（全球指数 + 恐贪指数）
  market-indices 获取全球主要市场指数行情
  analyze        分析指定股票/ETF的实时行情
